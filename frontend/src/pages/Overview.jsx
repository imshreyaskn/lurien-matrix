...
function MetricCard({ label, value, delta, highlight }) {
  return (
    <div className={`p-6 bg-luma-100/40 backdrop-blur-2xl border rounded-lg flex flex-col justify-between min-h-[140px] shadow-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] ${highlight ? 'border-accent-gold/50 shadow-[0_0_30px_rgba(212,184,158,0.15)]' : 'border-white/5'}`}>
