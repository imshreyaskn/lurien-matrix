  ...
  return (
    <div className="space-y-8 pb-12 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div className="p-6 bg-luma-100/40 backdrop-blur-2xl border border-white/5 rounded-lg flex flex-col justify-between min-h-[140px] shadow-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
        ...
        <div className="p-6 bg-luma-100/40 backdrop-blur-2xl border border-accent-gold/50 rounded-lg flex flex-col justify-between min-h-[140px] shadow-[0_0_30px_rgba(212,184,158,0.15)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
      ...
      <div className="bg-luma-100/40 backdrop-blur-2xl border border-white/5 rounded-lg p-8 shadow-xl">
